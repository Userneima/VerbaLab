    ...
    <View className="page-shell">
      <View className="hero-card">
        ...
        <Textarea
          ...
          maxlength={300}
          style="margin-top: 24px; width: 100%; min-height: 180px; box-sizing: border-box; border-radius: 20px; border: 1px solid #e4e7ec; padding: 20px; background: #fff; font-size: 12px;"
        />
        <Button
      ...
      {guide ? (
        <View className="result-card">
          ...
          <Textarea
            ...
            maxlength={500}
            style="margin-top: 16px; width: 100%; min-height: 140px; box-sizing: border-box; border-radius: 18px; border: 1px solid #e4e7ec; padding: 18px; background: #fff; font-size: 12px;"
          />
          <Button
            className="primary-button"
